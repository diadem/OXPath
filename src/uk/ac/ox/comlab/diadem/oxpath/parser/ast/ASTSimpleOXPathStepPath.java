...
public
class ASTSimpleOXPathStepPath extends SimpleNode {
  public ASTSimpleOXPathStepPath(int id) {
    super(id);
  }

  public ASTSimpleOXPathStepPath(OXPathParser p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=e8cce863ba5592f48460f3e23e421cae (do not edit this line) */
